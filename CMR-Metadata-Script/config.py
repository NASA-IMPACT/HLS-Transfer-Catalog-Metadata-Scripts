...
class BaseConfig:
    ...
    PAGE_NUM = os.getenv("PAGE_NUM", 1) # starting page number
    ...
    START_DATE = "2021-01-01T10:00:00Z"  # can be left empty string("") if not required as filter
    END_DATE = "2022-03-10T12:00:00Z" # can be left empty string("") if not required as filter
    BOUNDING_BOX="-10,-5,10,5" # can be left empty string("") if not required as filter
    PAGE_NUM_LIMIT = os.getenv("PAGE_NUM_LIMIT", 10) # This is used to limit the number of records in the CSV File
